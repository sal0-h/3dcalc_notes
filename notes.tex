...
A plane region $D$ is \textbf{type 1} if it lies between the graphs of two 
...
A plane region $D$ is \textbf{type 2} if it lies between the graphs of two 
...
\textbf{Properties:}
\begin{itemize}
    \item $\iint_D [f(x,y) + g(x,y)] \, dA = \iint_R f(x,y) \, dA + \iint_R g(x,y) \, dA$
